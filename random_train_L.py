...
def parse_args():
    ...
    parser.add_argument('-ds', '--dataset', default='curvevel-a-L', type=str, help='dataset name')
    ...
    parser.add_argument('-t', '--train_anno', default='curvevel_a_train_L.txt', help='name of train anno')
    parser.add_argument('-v', '--val_anno', default='curvevel_a_val_L.txt', help='name of val anno')
    ...
    parser.add_argument('-m', '--model', default='FourierDeeponet', type=str, help='inverse model name')
    ...
    parser.add_argument('--layer_sizes', nargs='+', type=int, default=[5, 256, 256, 256, 512], help='trunk_net layer sizes')
    # Training related
